...
macro_rules! Vect1 {
    (x: $x:expr) => (Vect1!($x));
    ($x:expr) => ($crate::linalg::Vect1::from(&[$x][..]));
}
...
macro_rules! Vect2 {
    ...
    ($x:expr, $y:expr) => ($crate::linalg::Vect2::from(&[$x, $y][..]));
}
...
macro_rules! Vect3 {
    ...
    ($x:expr, $y:expr, $z:expr) => ($crate::linalg::Vect3::from(&[$x, $y, $z][..]));
}
...
macro_rules! Vect4 {
    ...
    ($x:expr, $y:expr, $z:expr, $w:expr) => ($crate::linalg::Vect4::from(&[$x, $y, $z, $w][..]));
}


#[macro_export]
macro_rules! Vect5 {
    ($x:expr, $y:expr, $z:expr, $u:expr, $v:expr) => ($crate::linalg::Vect5::from(&[$x, $y, $z, $u, $v][..]));
}


#[macro_export]
macro_rules! Vect6 {
    ($x:expr, $y:expr, $z:expr, $u:expr, $v:expr, $w:expr) => ($crate::linalg::Vect6::from(&[$x, $y, $z, $u, $v, $w][..]))
}
